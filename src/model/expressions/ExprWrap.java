...
public class ExprWrap extends Expression {
    ...
    public RGBColor evaluate(double x, double y, double currentTime) {
        ...
        return new RGBColor(wrap(eval.getRed()),
                wrap((eval.getBlue())), wrap((eval.getGreen())));
    }
    ...
    /**
     * Wraps a double around [-1,1]. (i.e., 1.5 -> -0.5).
     * Algorithm: 
     * Nums > 1:  If i-1 >= 2, return -1 + ((i-1) % 2). Else return -1 + i.
     * Nums < 1: return -1 * answer from above.
     */
